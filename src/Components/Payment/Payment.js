  ...
  //       <div className="form-group-1-1-1 mb-3">
  //         <label htmlFor="cardDetails">Card Details</label> {/* Added label for CardElement */}
  //         <CardElement
  //           id="cardDetails" // ID added for accessibility
  //           className="form-control-pay"
  //           options={{
  //             style: {
  //               base: {
  ...
  // const Payment = () => {
  //   const [showModal, setShowModal] = useState(true); // Show modal by default on load
  ...
  //           <Modal.Title>Payment</Modal.Title> {/* Main Modal Title */}
  //         </Modal.Header>
  //         <Modal.Body>
